          ...
          >
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-1.5 bg-black dark:bg-white text-white dark:text-black text-xs font-medium rounded-md hover:opacity-80 transition-opacity">
                  <FaExternalLinkAlt className="text-xs" />
                  <span>View</span>
                </a>
                {project.githubUrl && (
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-xs font-medium rounded-md hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                {project.technologies.map((tech, techIndex) => (
                  <span key={techIndex} className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gray-200 dark:bg-white/5 rounded-full text-[10px] xs:text-xs text-gray-700 dark:text-gray-300">{tech}</span>
                ))}
              </div>
            </div>
          </div>
