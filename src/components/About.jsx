          ...
          <div className="flex gap-8">
            {['Home', 'Projects'].map((item) => (
              <a 
                ...
                className="text-[10px] uppercase tracking-[0.3em] font-medium text-gray-400 hover:text-black dark:hover:text-white transition-colors"
              >
                {item}
              </a>
            ))}
            <button 
              onClick={downloadCV}
              className="text-[10px] uppercase tracking-[0.3em] font-medium text-gray-400 hover:text-black dark:hover:text-white transition-colors flex items-center gap-2"
            >
          ...
          <div className="md:col-span-2">
            <div className="flex flex-col items-start text-left mb-20 space-y-8">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <h1 className="text-5xl md:text-8xl font-bold tracking-tighter text-black dark:text-white leading-none">
                    <span ref={headingRef} className="inline-block opacity-0">
              ...
              <div ref={socialRef} className="flex flex-wrap items-center gap-4 sm:gap-6 text-xl opacity-0">
                <a href={portfolioData.personal.social.email} className="text-[#EA4335] hover:text-[#EA4335] transition-colors">
                  <SiGmail />
                </a>
                <a href={portfolioData.personal.social.github} target="_blank" rel="noreferrer" className="text-black dark:text-white hover:opacity-80 transition-opacity">
                  <FaGithub />
                </a>
                <a href={portfolioData.personal.social.linkedin} target="_blank" rel="noreferrer" className="text-[#0A66C2] hover:text-[#0A66C2] transition-colors">
                  <FaLinkedin />
                </a>
                <a href={portfolioData.personal.social.whatsapp} target="_blank" rel="noreferrer" className="text-[#25D366] hover:text-[#25D366] transition-colors text-2xl">
                  💬
                </a>
            ...
            <div className="mt-12 md:mt-16">
              <h2 ref={aboutHeadingRef} className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8 opacity-0">
                About
              </h2>
          ...
          <div className="md:col-span-1 flex justify-center md:justify-end pt-8 md:pt-0">
            <div ref={profileImageRef} className="relative opacity-0">
              <div className="w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-black dark:border-white/20 shadow-2xl">
                <img 
                  src="https://via.placeholder.com/300/667eea/ffffff?text=Misheck+Gogo" 
                  alt="Misheck Gogo" 
